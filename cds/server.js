...
const StreamClusters = (stream) => {
  console.log('StreamClusters API call');
...
const IncrementalClusters = (call, callback) => {
  console.log(call, callback);
  callback();
};

const FetchClusters = (call, callback) => {
...
const Server = (port = 8001, ip = '0.0.0.0') => {
  ...
  server.addService(pb.ClusterDiscoveryService.service, implementation);
